...
tree.functions = {
    ...
    hue: function (color) {
        ...
        } else if (color instanceof tree.Dimension){			
            var hue = color.value % 360;
            return new(tree.Dimension)(hue < 0 ? 360 + hue : hue);
        } 
    },
    saturation: function (color) {        
        if (color instanceof tree.Color){
            ...
            return new(tree.Dimension)(clamp(parseFloat(color.unit == '%' ? color.value / 100 : color.value)) * 100, '%');
        } 
    },
    ...
    alpha: function (color) {    
        if (color instanceof tree.Color){
            ...
            return new(tree.Dimension)(clamp(parseFloat(color.value)));
        }
    },
    luma: function (color) {
        if (color instanceof tree.Color){
